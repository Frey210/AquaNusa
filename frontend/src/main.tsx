...
function Login({ onLogin }: { onLogin: (user: User) => void }) {
  ...
  return <main className="login-page">
    <section className="login-brand" aria-label="Tentang AquaNusa"><img className="brand-lockup" src="/brand-lockup.png" alt="AquaNusa" width="1200" height="212" /><p className="eyebrow">AquaNusa Water Intelligence</p><h1>Data perairan yang tepat, untuk keputusan yang lebih tenang.</h1><p>Masuk untuk memantau suhu, oksigen terlarut, pH, kelembapan, dan cahaya dari perangkat Anda.</p></section>
