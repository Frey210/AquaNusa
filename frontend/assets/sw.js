...
const CACHE = "aquanusa-v6";
const SHELL = ["/", "/brand-mark.png", "/brand-wordmark.png", "/brand-lockup.png", "/manifest.webmanifest", "/icons/icon-192.png", "/icons/icon-512.png", "/icons/icon-maskable-512.png"];
